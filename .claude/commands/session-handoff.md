...
```bash
python .claude/skills/session-handoff/scripts/create_handoff.py [task-slug]
```

Example: `python .claude/skills/session-handoff/scripts/create_handoff.py implementing-user-auth`

**For continuation handoffs** (linking to previous work):
```bash
python .claude/skills/session-handoff/scripts/create_handoff.py "auth-part-2" --continues-from 2024-01-15-auth.md
```
...
Use the template structure in [.claude/skills/session-handoff/references/handoff-template.md](.claude/skills/session-handoff/references/handoff-template.md) for guidance.
...
```bash
python .claude/skills/session-handoff/scripts/validate_handoff.py <handoff-file>
```
...
```bash
python .claude/skills/session-handoff/scripts/check_staleness.py <handoff-file>
```
...
Follow the checklist in [.claude/skills/session-handoff/references/resume-checklist.md](.claude/skills/session-handoff/references/resume-checklist.md):
...
- [handoff-template.md](.claude/skills/session-handoff/references/handoff-template.md) - Complete template structure with guidance
- [resume-checklist.md](.claude/skills/session-handoff/references/resume-checklist.md) - Verification checklist for resuming agents
